...
enum PatchPackageFile {
    static let fileExtension = "enyellts"
    static let typeIdentifier = "com.enyell.ts.patch-package"

    // Existing encrypted packages and their Keychain identities remain valid.
    static func accepts(_ url: URL) -> Bool {
        [fileExtension, "3105"].contains(url.pathExtension.lowercased())
    }
}
